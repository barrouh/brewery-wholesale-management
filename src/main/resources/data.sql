...
INSERT INTO beer (id, name, alcohol_percentage, price, brewery_id) VALUES (2, 'Ardenne Saison', 5.5, 2.0, 1);
INSERT INTO beer (id, name, alcohol_percentage, price, brewery_id) VALUES (3, 'Avril', 3.5, 1.30, 1);
INSERT INTO beer (id, name, alcohol_percentage, price, brewery_id) VALUES (4, 'St. Feuillien Blonde', 7.5, 3.00, 2);
